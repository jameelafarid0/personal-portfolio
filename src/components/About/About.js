        ...
        <div className="body2">
            ...
            <div className="d-flex justify-content-center  mt-5 pt-5">
                ...
                <div className="col-md-4" >
                    <img className="imgMe2" src={'https://i.imgur.com/wLhH7Fm.png'} alt="" />
                </div>

                <div className="positon col-md-6 pl-3">
                    <h4 className="h4" style={{color:" white"}}>A diligent Front End Developer. Acquiring skills in technology has always been my interest therefore I approached a course and soon found myself getting engrossed in it, where I gained lots of skills and knowledge in web programming.</h4>
                    <br />
